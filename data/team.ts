...
export const bbcTrio: TeamMember[] = [
  {
    ...
    responsibilities: [
      ...
      'Engineering leadership across BBC integration points',
      'Input into experiment approval decisions',
    ],
  },
  {
    id: 'adam-flint',
    ...
    responsibilities: [
      ...
      'Experiment and roadmap decision-making',
    ],
  },
  {
    id: 'bob-hamilton',
    ...
    responsibilities: [
      ...
      'Design approval and strategic UX input',
    ],
  },
]

export const hippoDeliveryTeam: TeamMember[] = [
  {
    id: 'jack-haith',
    name: 'Jack Haith',
  ...
  },
  {
    ...
    responsibilities: [
      'Delivery management',
      'Sprint/project coordination',
      'Stakeholder comms and tracking',
    ],
  },
  {
    id: 'steady',
